...
<body>
	...
	<div class="wrapper">
			...
			<div class="sidebar-left sidebar-nicescroller" id="sidebar-left">
				<div class="float">
					...
					<ul class="sidebar-menu" id="side-menu">
						<li><a href='#'><i class='fa fa-sitemap fa-fw'></i>订单管理<i
		...
		<div class="sidebar-right-heading">
			<ul class="nav nav-tabs square nav-justified">
				...
				<li>
					<!-- <a href="#online-user-sidebar" data-toggle="tab"><i class="fa fa-comments"></i></a> -->
				</li>
				<li>
					<!-- <a href="#task-sidebar" data-toggle="tab"><i class="fa fa-tasks"></i></a> -->
				</li>
				<li>
					<!-- <a href="#setting-sidebar" data-toggle="tab"><i class="fa fa-cogs"></i></a> -->
				</li>
			</ul>
		</div>
	...
	<!-- /.wrapper -->
	<!-- END PAGE CONTENT -->
	<div id="ajax-pwdModifyModal" class="modal fade" role="dialog"
		tabindex="-1" style="display: none;"></div>
	<div id="ajax-lockScreenModal" class="modal fade" role="dialog"
		tabindex="-1" style="display: none;"></div>
	<div id="ajax-versionModal" class="modal fade" role="dialog"
		tabindex="-1" style="display: none;"></div>
</body>
</html>