  ...
  <div class="panel-group" id="accordion">
	<div class="col-lg-12">
	  	<div class="panel-body" >
	  	 ...
	  	   <button type="button" id="goBackButton"   onclick="goBack();"  class="btn btn-primary glyphicon glyphicon-arrow-left"> 返回</button>       
					
           <button class="btn btn-primary glyphicon glyphicon-print" id="printHT"
