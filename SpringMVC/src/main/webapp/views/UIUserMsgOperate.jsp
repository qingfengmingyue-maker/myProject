										...
										<div class="row form-group">
											...
											<div class="col-xs-8">
												<input class="form-control required" id="userPwd" name="userPwd"
													maxlength="10" type="password" value="${userMsg.userPwd  ==null ? '1234':userMsg.userPwd}"
													${editType == 'view' ? 'readonly' : ''}>
											</div>
										</div>
									</div>
									<div class="col-xs-2" align="left" style="padding-left: 0px;margin-top: 8px;margin-left: -5%">
										      <span style="color:red"> (初始密码为"1234")</span>
								     </div>
								</div>
								<div class="row">
									<div class="col-lg-2 col-md-2 col-xs-2"></div>
